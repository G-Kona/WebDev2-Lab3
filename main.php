...
if (isset($_POST['submit'])) {
    ...
    if (trim($_POST['fName']) == '') {
        ...
        $flag = false;
    } else if (strlen(trim($_POST['fName'])) > 50) {
    ...
    if (trim($_POST['lName']) == '') {
        ...
        $flag = false;
    } else if (strlen(trim($_POST['lName'])) > 50) {
    ...
    //Rating Validation
    if (!isset($_POST['rate'])) {
        $err_rate = 'Please give us a rating';
        $flag = false;
    } else {
        $rating = $_POST['rate'];
    }
        ...
        <div class="<?= htmlspecialchars($mainFormClass) ?>">
            <form id="mainForm" name="mainForm" action="index.php" method="post">
                ...
                <div id="mainForm__ratingsBlock">
                    <input type="radio" name="rate" id="rad1" class="hide"
                    ...
                    <input type="radio" name="rate" id="rad2" class="hide"
                    ...
                    <input type="radio" name="rate" id="rad3" class="hide"
                    ...
                    <input type="radio" name="rate" id="rad4" class="hide"
                    ...
                    <input type="radio" name="rate" id="rad5" class="hide"
                ...
                <label id="mainForm__error_rating"
                       class="inputFields__error center"><?= htmlspecialchars($err_rate) ?></label>
                ...
                <div id="mainForm__inputFields">
                    <div id="inputFields__topBlock">
                        ...
                        <select id="mainForm__rad_category" class="inputFields__input" name="feedback">
                            <option value="General" <?= ($feedback == 'General') ? ('selected') : (''); ?>>
                                General
                            </option>
                            <option value="Suggestion" <?= ($feedback == 'Suggestion') ? ('selected') : (''); ?>>
                                Suggestion
                            </option>
                            <option value="Compliment" <?= ($feedback == 'Compliment') ? ('selected') : (''); ?>>
                                Compliment
                            </option>
                        </select>
                    </div>
